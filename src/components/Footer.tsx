      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="text-2xl font-bold text-white mb-4">Elegante</div>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-medium mb-6 uppercase tracking-wider">
              Quick Links
            </h3>
            <ul className="space-y-3">
              <li>
                <a
                  href="#"
                  className="text-gray-300 hover:text-rose-400 transition-colors font-light"
                >
                  About Us
                </a>
              </li>
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-start">
                ...
                <span className="text-gray-300 text-sm font-light">
                  123 Fashion Avenue, Style District, NY 10001
                </span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-300 text-sm font-light break-all">
                  hello@elegante.com
                </span>
              </div>
            </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm font-light text-center md:text-left">
              © 2025 Elegante. All rights reserved.
            </p>
            <div className="flex items-center">
              <span className="text-gray-400 text-sm mr-2 font-light">
                Crafted with
              </span>
